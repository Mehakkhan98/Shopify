				...
				{cartItemsIsLoading ? (
							...
							<View key={i} style={{flexDirection: 'row', backgroundColor: '#fff', marginBottom: 2, height: 120}}>
								<View style={[styles.centerElement, {width: 60}]}>
									<TouchableOpacity style={[styles.centerElement, {width: 32, height: 32}]} onPress={() => this.selectHandler(i, item.checked)}>
                                        <Ionicons name={item.checked == 1 ? "ios-checkmark-circle" : 
                                        "ios-checkmark-circle-outline"} size={25} color={item.checked == 1 ? "#0faf9a" : "#aaaaaa"} />
									</TouchableOpacity>
								</View>
                    ...
                    <Text numberOfLines={1} style={{color: '#333333', marginBottom: 10}}>${item.qty * item.salePrice}</Text>
								...
								<View style={[styles.centerElement, {width: 60,flexDirection:'row',marginRight:10}]}>
									<TouchableOpacity style={[styles.centerElement, {width: 32, height: 32,marginHorizontal:5}]} onPress={() => this.addtoCart(i)}>
										<Ionicons name="md-cart" size={25} color="#0faf9a" />
									</TouchableOpacity>
